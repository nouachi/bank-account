...
public class AccountServiceTest {
    ...
    public void can_print_a_statement() {
        ...
        assertThat(statement, is("operation - date - amount - totalBalance\n" +
                "Deposit - 15/03/2019 10:15:30 - 500.0 - 500.0\n" +
                "Withdrawal - 30/04/2019 23:12:30 - 320.0 - 180.0\n" +
                "Withdrawal - 01/05/2019 10:16:54 - 100.0 - 80.0\n" +
                "Withdrawal - 05/05/2019 14:12:30 - 20.0 - 60.0\n" +
                "Deposit - 06/05/2019 23:12:30 - 30.0 - 90.0"
        ));
    }
    ...
    private class FakeAccountService extends AccountService {
        ...
        protected LocalDateTime now() {
            ...
            switch (operationCount) {
                case 1:
                    return LocalDateTime.parse("2019-03-15T10:15:30.00");
                case 2:
                    return LocalDateTime.parse("2019-04-30T23:12:30.00");
                case 3:
                    return LocalDateTime.parse("2019-05-01T10:16:54.00");
                case 4:
                    return LocalDateTime.parse("2019-05-05T14:12:30.00");
                case 5:
                    return LocalDateTime.parse("2019-05-06T23:12:30.00");
                default:
